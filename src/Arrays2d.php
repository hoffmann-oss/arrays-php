...
final class Arrays2d
{
	...
	public static function fill(array &$array, $item = null,
	...
	public static function replace(array &$array, array $source, int $x = 0, int $y = 0,
			int $startX = 0, int $startY = 0, int $stopX = null, int $stopY = null)
	{
		$startX = max($startX, $x);
		$startY = max($startY, $y);
	 ...
	 */
	public static function rotateX(array &$array, int $distance,
			int $startX = 0, int $startY = 0, int $stopX = null, int $stopY = null)
	{
		self::prepare($array, $stopX, $stopY);
	 ...
	 */
	public static function rotateY(array &$array, int $distance,
			int $startX = 0, int $startY = 0, int $stopX = null, int $stopY = null)
	{
		self::prepare($array, $stopX, $stopY);
		$rotateUp = $distance > 0;
	...
	public static function swapX(array &$array, int $x1, int $x2,
			int $startY = 0, int $stopY = null)
	{
	...
	public static function swapY(array &$array, int $y1, int $y2,
			int $startX = 0, int $stopX = null)
	{
